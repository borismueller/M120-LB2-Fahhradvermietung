...
namespace Positivtest_1
{
    ...
    public partial class UIMap
    {
        ...
        public void startup()
        {
            ...
            Mouse.DoubleClick(uINameEdit, new Point(93, 4));
        }
        
        /// <summary>
        /// neu - Verwenden Sie "neuParams", um Parameter an diese Methode zu übergeben.
        /// </summary>
        public void neu()
        {
            #region Variable Declarations
            ...
            Mouse.Click(uISystemDynamicExpandoListItem, new Point(182, 12));

            // Klicken "Neu" Schaltfläche
            Mouse.Click(uINeuButton, new Point(151, 9));

            // Klicken Schaltfläche
            Mouse.Click(uIItemButton, new Point(29, 8));

            // Klicken "Antener" Bezeichnung
            Mouse.Click(uIAntenerText, new Point(19, 9));

            // Klicken "Speichern" Schaltfläche
            Mouse.Click(uISpeichernButton, new Point(104, 13));

            // Klicken Schaltfläche
            Mouse.Click(uIItemButton1, new Point(25, 11));

            // Klicken "Scott" Bezeichnung
            Mouse.Click(uIScottText, new Point(23, 3));

            // Klicken "Speichern" Schaltfläche
            Mouse.Click(uISpeichernButton1, new Point(191, 39));

            // "5/6/2017 8:00:00 AM" in "1/1/0001 12:00:00 AM" Zelle eingeben
            uIItem110001120000AMCell.Value = this.neuParams.UIItem110001120000AMCellValue;

            // '{Tab}' in Textfeld eingeben
            Keyboard.SendKeys(uIItemEdit, this.neuParams.UIItemEditSendKeys, ModifierKeys.None);

            // "5/6/2017 4:00:00 PM" in "1/1/0001 12:00:00 AM" Zelle eingeben
            uIItem110001120000AMCell1.Value = this.neuParams.UIItem110001120000AMCell1Value;

            // '{Enter}' in Textfeld eingeben
            Keyboard.SendKeys(uIItemEdit1, this.neuParams.UIItemEditSendKeys1, ModifierKeys.None);

            // Klicken "Speichern" Schaltfläche
            Mouse.Click(uISpeichernButton2, new Point(268, 15));
        }
        ...
        #region Properties
        public virtual neuParams neuParams
        {
            get
            {
                if ((this.mneuParams == null))
                {
                    this.mneuParams = new neuParams();
                }
                return this.mneuParams;
            }
        }
    ...
    /// <summary>
    /// An "neu" zu übergebende Parameter
    /// </summary>
    [GeneratedCode("Coded UI-Test-Generator", "14.0.23107.0")]
    public class neuParams
    {
    ...
    public class UILb_vermietungList : WpfList
    {
        ...
        public WpfListItem UISystemDynamicExpandoListItem1
        {
            get
            {
                if ((this.mUISystemDynamicExpandoListItem1 == null))
                {
                    this.mUISystemDynamicExpandoListItem1 = new WpfListItem(this);
                    #region Suchkriterien
                    this.mUISystemDynamicExpandoListItem1.SearchProperties[WpfListItem.PropertyNames.Name] = "System.Dynamic.ExpandoObject";
                    this.mUISystemDynamicExpandoListItem1.SearchProperties[WpfListItem.PropertyNames.Instance] = "5";
                    this.mUISystemDynamicExpandoListItem1.WindowTitles.Add("MainWindow");
                    #endregion
                }
                return this.mUISystemDynamicExpandoListItem1;
            }
        }
        #endregion
        ...
        private WpfListItem mUISystemDynamicExpandoListItem1;
        #endregion
    }
